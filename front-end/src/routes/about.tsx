		...
		<Section title="About me">
			<div className="flex flex-col gap-12 text-xl lg:text-2xl max-w-160">
				<p>
					...
					and keep everyone feeling heard. I love making space for creativity to flow—when you actually look forward to
					Monday mornings.
				</p>
				<p>
					I'm a big believer in talking things out, even if it's just to vent about that one font that's driving us all
					crazy. I'm also the one who'll order the emergency pizza when we're pulling a late one, and probably bring my
					dog, Biscuit, to the office for morale.
